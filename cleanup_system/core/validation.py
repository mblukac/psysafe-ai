...
class ValidationEngine:
    ...
    def _check_local_import(self, module_name: str, file_path: Path) -> bool:
        ...
        if module_name.startswith("psysafe"):
            ...
            return check_path.with_suffix(".py").exists() or (check_path / "__init__.py").exists()
    ...
    def get_validation_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "critical_failures": [
                r.message for r in self.validation_results if not r.passed and r.severity == "critical"
            ],
        }
    ...
    def _get_python_files(self) -> List[Path]:
        ...
        for file_path in self.project_root.rglob("*.py"):
            ...
            if any(
                ...
                for part in [".git", "__pycache__", ".pytest_cache", ".mypy_cache", "cleanup_system"]
            ):
                continue
