...
from ..core.base import CleanupPhase, CleanupReport, CodeCleanupBase
...
class TestValidator(CodeCleanupBase):
    ...
    def validate_no_regressions(self, current_results: TestBaseline) -> bool:
        ...
        if current_results.total_passed < baseline.total_passed:
            print(
                f"Regression detected: passed tests decreased from {baseline.total_passed} to {current_results.total_passed}"
            )
            return False
