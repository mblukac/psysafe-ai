...
class ProgressTracker:
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        for phase, progress in self.phase_progress.items():
            ...
            phase_summaries[phase.value] = {
                ...
                "estimated_remaining_seconds": (
                    progress.estimated_remaining.total_seconds() if progress.estimated_remaining else None
                ),
        ...
        return {
            "overall": {
                ...
                "current_phase": (
                    self.overall_progress.current_phase.value if self.overall_progress.current_phase else None
                ),
                "overall_percentage": self.overall_progress.overall_percentage,
                "duration_seconds": overall_duration,
                "estimated_completion": (
                    self.overall_progress.estimated_completion.isoformat()
                    if self.overall_progress.estimated_completion
                    else None
                ),
            },
    ...
    def print_progress(self) -> None:
        ...
        print(
            f"Phases: {overall.completed_phases} completed, {overall.failed_phases} failed, {overall.skipped_phases} skipped"
        )
