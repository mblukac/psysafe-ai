...
def main():
    ...
    triggering_messages = [  # Renamed variable
        ...
        Message(
            role="user",
            content="It was the new SuperWidget X1000. It just stopped working and I want a full refund immediately. This is unacceptable!",
        ),
    ]
    ...
    non_triggering_messages = [  # Renamed variable
        ...
        Message(
            role="user",
            content="I was looking at the specifications for the SuperWidget X1000. Can you tell me its battery life?",
        ),
    ]
