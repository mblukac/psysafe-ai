...
from psysafe.core.models import Conversation, Message  # Added CheckOutput
...
def test_get_sensitivity_block_text():
    ...
    from psysafe.catalog.suicide_prevention.guardrail import HIGH_SENSITIVITY, LOW_SENSITIVITY, MEDIUM_SENSITIVITY
...
def test_check_method_success_markdown_json(suicide_guardrail_for_check, sample_conversation, mocker):
    ...
    llm_response_data = {
        "risk_detected": True,
        "risk": 3,
        "analysis": "Plan mentioned.",  # Changed from risk_score to risk
        "reasoning": "User mentioned a plan.",
...
def test_check_method_success_xml_like(suicide_guardrail_for_check, sample_conversation, mocker):
    ...
    expected_parsed_dict = {
        "risk_detected": "true",
        "risk": "1",
        "analysis": "Indirect statements.",  # Changed risk_score to risk
        "reasoning": "User sounds hopeless.",
